                ...
                <div class="show-area">
                    <div class="clearfix">
                        <div class="profile-form">
                            <form action="includes/admin-update.inc.php" method="POST" name="profile-form-area"
                                ...
                                <div class="row">
                                    <div class="clearfix">
                                        ...
                                        <div class="profile-textB">
                                            <input type="text" id="name" name="a_name" placeholder="Name"
                                                value="<?php if(isset($_GET['a_name'])) echo $_GET['a_name'];?>" />
                                        </div>
                                        <div class="error">
                                ...
                                <div class="row">
                                    <div class="clearfix">
                                        ...
                                        <div class="profile-textB">
                                            <input type="text" id="surname" name="a_surname" placeholder="Surname"
                                                value="<?php if(isset($_GET['a_surname'])) echo $_GET['a_surname'];?>" />
                                        </div>
                                        <div class="error">
                                ...
                                <div class="row">
                                    <div class="clearfix">
                                        ...
                                        <div class="profile-textB">
                                            <input type="password" id="password" name="a_password"
                                ...
                                <div class="row">
                                    <div class="clearfix">
                                        ...
                                        <div class="profile-textB">
                                            <input type="password" id="cpassword" name="a_cpassword"
                                ...
                                <div class="row">
                                    <div class="clearfix">
                                        ...
                                        <div class="profile-file">
                                            <input type="file" id="picture" name="a_picture_upload" accept="image/*" />
                                        </div>
                                        <div class="error">
