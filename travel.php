        ...
        if(isset($_SESSION["user_id"])) {
            ...
            if(isset($_GET["city"]))
            {
                ...
                if($current_city == null)
                    ...
                    $city_details = $current_city["details"];
                }
        ...
        <div class="container">
            ...
            <div class="travel-area">
                <div class="travel-city-area">
                    ...
                    <p class="half-p">
                        <?php echo $city_details; ?>
                    </p>
                </div>
                <div class="travel-form-area">
                    <form
                        action="includes/reservate.inc.php?<?php echo "city=" . $_GET['city'] . "&" . "price=" . $city_price?>"
                        name="reservation_form" method="post" onsubmit="return validate_reservation();">
                        <h2>Traveller's,</h2>
                        <div class="input-area">
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input type="text" name="traveller_name"
                                        value="<?php echo $_SESSION['user_fname'];?>" readonly />
                                </div>
                            </div>
                            <div class="clearfix">
                                <div class="label-field">
                                ...
                                <div class="input-field">
                                    <input type="text" name="traveller_lname"
                                        value="<?php echo $_SESSION['user_lname'];?>" readonly />
                                </div>
                            </div>
                            <div class="clearfix">
                                <div class="label-field">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input type="text" name="traveller_credit" placeholder="9999999999999999" ; value=""
                        ...
                        <div class="input-area">
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input id="people-count" type="number" value="1" min="1" max="6"
                                        name="traveller_count" autocomplete="off"
                        ...
                        <div class="input-area">
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input type="text" name="traveller_city"
                                        value="<?php echo $city_name . "-" . $city_country;?>" readonly />
                                </div>
                            </div>
                            <div class="clearfix">
                                <div class="label-field">
                                ...
                                <div class="input-field">
                                    <input id="start-date-picker" type="date" name="traveller_sdate"
                            ...
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input id="end-date-picker" type="date" name="traveller_edate"
                                        value="<?php echo $today; ?>" min="<?php echo $today;?>"
                                        onchange="set_dates(<?php echo $city_price;?>);" />
                                </div>
                            </div>
                            <div class="clearfix">
                                ...
                                <div class="input-field">
                                    <input id="days-count" type="number" min="1" value="1" name="traveller_days"
                                        readonly />
                                </div>
                            </div>
                        </div>
