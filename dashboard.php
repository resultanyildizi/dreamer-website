    ...
    <div class="clearfix">
        <div class="menu-side">
            <div class="profile-menu">
                <div class="clearfix">
                    <a href="admin_profile.php"><img src="<?php echo 'resources/admin_images/'.$picture_url;?>"
                            alt="profile_pic" /></a>
            ...
            <nav class="admin-navbar">
                <ul>
                    ...
                    <li>
                        <a href="admin_profile.php"><i class="fas fa-user-alt"></i><label>Profile</label></a>
                    </li>
                </ul>
            </nav>
        </div>
        ...
        <div class="content">
            ...
            <div class="main-content">
                ...
                <div class="city-input-area">
                    ...
                    <div class="city-area">
                        <form action="includes/city-add.inc.php" class="city-form-area" name="city_form_area"
                            method="post" enctype="multipart/form-data" onsubmit="return validate_city()">
                            <div class="clearfix">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="city-textB">
                                                <input type="text" id="name" name="name"
                                                    value="<?php if(isset($_GET['c_name'])) echo $_GET['c_name'];?>" />
                                            </div>
                                            <div class="error">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="city-textB">
                                                <input type="text" id="country" name="country"
                                                    value="<?php if(isset($_GET['c_country'])) echo $_GET['c_country'];?>" />
                                            </div>
                                            <div class="error">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="city-textB">
                                                <input type="text" id="cost" name="cost"
                                                    value="<?php if(isset($_GET['c_price'])) echo $_GET['c_price'];?>" />
                                            </div>
                                            <div class="error">
                                ...
                                <div class="city-pic-area">
                                    <div class="clearfix">
                                        <div class="small-img-field">
                                            <div id="city_small_img" class="small-img"
                                                style="background-image: url('resources/undefined_image.jpg')"></div>
                                            <input id="small_img_inp" type="file" name="small_img" />
                                            <div class="error">
                                                <p><?php if(isset($_GET["error"])) echo "*Error has occured. One of the pictures has invalid image format"?>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="back-img-field">
                                            <div id="city_back_img" class="back-img"
                                                style="background-image: url('resources/undefined_image.jpg')"></div>
